 ...
 * 
 */
public class TestSkisApplication extends Application {
	public static String dbName = "skieur_tests2012_.sqlite";
	...
	public ProductDetailFragment getProductDetailFragment(DBHelper helper,
		...
		return ProductDetailFragment.getInstance(this, helper,
				...
				R.string.ProductDetailWebPage, c, new String[] { "Marque",
						...
						"icone_top", "img_niveau",
						"icone_wide", "img_polyvalence", "Caractéristiques",
						...
						"%icone_cambres%", "%icone_top%",
						"%img_niveau%",
						"%icone_wide%", "%img_polyvalence%",
						"%Caractéristiques%",
